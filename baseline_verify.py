...
Modes:
  ...
  --coreml    : YOLO26x CoreML FP16 ANE runtime benchmark
...
def main():
    ...
    print(
        f"[SYSTEM]: Initializing Arducam USB Global Shutter camera on index {cam_index}..."
    )
    ...
    if args.compare:
        ...
        cap, pt_fps = run_backend(
            cap, cam_index, "yolo26n.pt", "PyTorch MPS", "Baseline - PyTorch MPS"
        )
