...
YOLO11 performs object detection for apples, discard triggers, and surface defects. A deterministic grading engine evaluates severity, spatial relationships, and defect coverage to produce final classification outcomes.
...
IoA = \frac{Intersection Area}{Defect Area}
